...
public interface UserRepository extends MongoRepository<User, String> {
	...
	// Podemos fazer o @Query também, assim como JPA, a semântica diverge bastante, mas é em formato de JSON. gte = greater than equals, lte = lesser than equals, and significa que precisa ser as duas condições do array (ou mais condições) e o $ sempre se refere a alguma palavra reservada nas queries no mongo.
